...
/****** Object:  StoredProcedure [dbo].[hssp_RPT_LogShipping_NoRecovery]    Script Date: 7/22/2016 9:19:31 AM ******/
SET ANSI_NULLS ON
GO
...
CREATE PROC [dbo].[hssp_RPT_LogShipping_NoRecovery]
...
IF @tn > 0 AND  @ProcessingFlag = 'RUN' BEGIN -- put database into stand by
	PRINT '-- Log shipping is done at ' + @dbname + ' in NoRecovery mode'
	-- EXEC (@strrestorecmd)
END
--
...
END -- hssp_RPT_LogShipping_NoRecovery
